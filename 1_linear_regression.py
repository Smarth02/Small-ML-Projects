...
Here, a Linear Regression model is implemented. Different scenarios are tested with the data and the model. A good idea is to play with the model parameters and the data frame columns. The result could be improved if the outliers are removed. 
